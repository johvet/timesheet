...
describe CustomersController do
  context "as a guest" do
    it "should redirect to sign in page" do
      get :index
      page.should redirect_to(new_user_session_path)
    end
  end
  ...
  context "as a valid user" do
    ...
    describe "GET index" do
      it "assigns all customers as @customers" do
        ...
        second = FactoryGirl.create(:customer, name: "Other", user: other_user)
    ...
    describe "POST create" do
      describe "with valid params" do
        it "creates a new Customer" do
          expect {
            post :create, {:customer => {name: "Sam Shmoe"}}
          }.to change(Customer, :count).by(1)
        end

        it "assigns a newly created customer as @customer" do
          post :create, {:customer => {name: "Samuel Shmoe"}}
    ...
    describe "PUT update" do
      ...
      describe "with valid params" do
        it "updates the requested customer" do
          ...
          put :update, {:id => @customer.to_param, :customer => { "name" => "MyString" }}
        end

        it "assigns the requested customer as @customer" do
          put :update, {:id => @customer.to_param, :customer => {name: "funny"}}
          assigns(:customer).should eq(@customer)
        end
